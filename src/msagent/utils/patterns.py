...
def two_part_matcher(name: str, module: str, on_invalid: Callable[[str], None] | None = None) -> Callable[[str], bool]:
...
def three_part_matcher(
    ...
    def match(p: str) -> bool:
        ...
        return fnmatch(category, cat_p) and fnmatch(module, mod_p) and fnmatch(name, name_p)
