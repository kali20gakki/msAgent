...
class MCPServerConfig(VersionedConfig):
    ...
    repair_timeout: int | None = Field(default=None, description="Repair command timeout in seconds")
    stateful: bool = Field(
        default=False,
    ...
    invoke_timeout: float | None = Field(default=None, description="Tool invocation timeout in seconds")
